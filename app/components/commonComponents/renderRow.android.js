...
function renderRow (data, sectionId, rowId, highlightRow){
    ...
    if(this.state.compactList==true){
        ...
        return(
            <TouchableNativeFeedback onPress={() => this.props.navigation.navigate('EntryView', { slug: slug})} onLongPress={() => onPressShare(slug, title)} background={TouchableNativeFeedback.SelectableBackground()}>
    ...
    return(
        ...
        <View style={this.state.listStyles.row} >
            ...
            <TouchableNativeFeedback onPress={() => this.props.navigation.navigate('EntryView', { slug: slug})} onLongPress={() => onPressShare(slug, title)} background={TouchableNativeFeedback.Ripple("#808080",true)}>
                <View style={listStyles.rowBody}>
